...
//   // ✅ Safely use Router hooks inside effect
//   useEffect(() => {
//     try {
//       const navigate = useNavigate();
//       const location = useLocation();
...
//       }
//     } catch (err) {
//       console.warn("Router not ready yet, skipping location logic");
//     }
//   }, [cities, selectedCity, dispatch]);

//   // ✅ Wrap city select navigation in a safe callback
//   const handleCitySelect = (city) => {
//     try {
//       const navigate = useNavigate();
//       const location = useLocation();
...
//       setClearFilter(true);
//     } catch (err) {
//       console.warn("Cannot navigate — Router not ready yet.");
//     }
//   };
